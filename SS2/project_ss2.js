...
console.log(acc);
console.log('the mark average is => ' + acc / citiesList.length );



//Para que me diga cuales son los últimos vuelos del día
//creo que hay que hacerlo con un for in

	function lastFlights (){
		var i;
		for (i=5; i<travels.length; i++){



console.log('Los últimos vuelos del día son => ' +travels.to );
}
}
lastFlights();
...
var travels = function (id, to, from, cost, scale){
